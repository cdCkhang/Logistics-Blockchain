...
contract Tracking {
    ...
    public payable{
        ...
        Shipment memory shipment = Shipment (msg.sender, _receiver, _pickupTime,
            0, _distance, _price, ShipmentStatus.PENDING, false);
    ...
    function startShipment (address _sender, address _receiver, uint256 _index) public {
        ...
        require(shipment.status == ShipmentStatus.PENDING, "Shipment is already on transit");
    ...
    function getShipments(address _sender, uint256 _index) public view returns (address, address, uint256, uint256,
